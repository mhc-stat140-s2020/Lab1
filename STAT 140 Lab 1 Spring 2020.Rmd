...
Text formatting in R Markdown: maybe point them to a cheat sheet here so we don't have to go through all of the details

Spellcheck in R Markdown: need to figure out how to implement this
...
- need unique names
- what happens if the name is not unique?
...
start with a basic introduction here -- maybe just scatterplots.

ggplot()

- scatterplots

<!-- Make portion of homework assignment dedicated to debugging each week -->
